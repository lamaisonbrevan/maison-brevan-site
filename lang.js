...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    fr: {
      ...
      'section.checkLine1': 'Les chambres sont à libérer pour 10h le jour du départ.',
      'section.checkLine2': 'L’accueil se fait à partir de 16h00 et jusqu’à 20h30.',
      'section.checkLine3': 'Pour toute arrivée tardive, merci de nous prévenir afin que nous puissions organiser votre accueil.',
      ...
      'services.breakfast.heading': 'Petit‑déjeuner inclus ',
      'services.breakfast.desc': 'Commencez la journée autour d’un petit‑déjeuner composé de produits locaux, sélectionnés avec soin pour leur qualité et leur authenticité.',
    ...
    en: {
      ...
      'section.checkHeading': 'Check In/Out',
      'section.checkLine1': 'Rooms must be vacated by 10:00 am on the day of departure.',
      'section.checkLine2': 'Check-in is from 4:00 pm to 8:30 pm.',
      'section.checkLine3': 'For late arrivals, please let us know so we can arrange your check-in.',
      'section.servicesHeading': 'Services',
      ...
      'services.breakfast.heading': 'Breakfast included ',
      'services.breakfast.desc': 'Start the day with a breakfast made with local products, carefully selected for their quality and authenticity.',
    ...
    es: {
      ...
      'section.checkHeading': 'Check In/Out',
      'section.checkLine1': 'Las habitaciones deben quedar libres para las 10:00 el día de salida.',
      'section.checkLine2': 'La recepción se realiza a partir de las 16:00 y hasta las 20:30.',
      'section.checkLine3': 'Para cualquier llegada tardía, por favor avísenos para que podamos organizar su llegada.',
      ...
      'services.breakfast.heading': 'Desayuno incluido ',
      'services.breakfast.desc': 'Empiece el día con un desayuno compuesto por productos locales, seleccionados cuidadosamente por su calidad y autenticidad.',
    ...
    de: {
      ...
      'section.checkLine1': 'Die Zimmer sind am Abreisetag bis 10:00 Uhr freizugeben.',
      'section.checkLine2': 'Der Check-in ist von 16:00 bis 20:30 Uhr möglich.',
      'section.checkLine3': 'Bei späterer Anreise bitten wir Sie, uns zu informieren, damit wir Ihren Empfang organisieren können.',
      ...
      'services.breakfast.heading': 'Frühstück inklusive ',
      'services.breakfast.desc': 'Beginnen Sie den Tag mit einem Frühstück aus lokalen Produkten, sorgfältig ausgewählt wegen ihrer Qualität und Authentizität.',
